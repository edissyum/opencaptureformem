...
The ./Makefile command create the service, but you may want to change the User and Group (edissyum by default) so just open the ./Makefile and change lines **79**, **80** and **114**
